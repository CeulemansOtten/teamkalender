...
function LegendList({ open }: { open: boolean }) {
  ...
  return (
    ...
    >
      <LegendItem color={COLORS.schoolBg} label="Feestdag" open={open} delay={baseDelay * 0} />
      <LegendItem color={COLORS.birthdayBg} label="Wachtdienst" open={open} delay={baseDelay * 1} />
    </div>
  );
}
